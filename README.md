...
1. Create a virtual environment and install `requirements.txt`.
   ...
   **Important note:** `flask-mysqldb` is stable only on Python 3.7–3.11 under Windows. Under Ubuntu it requires a 'libmysqlclient-dev' package.  
...
- Copy .env-examples to the project root
- Change values
- Rename to .env
